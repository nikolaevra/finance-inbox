...
from apis.connect_slack import router as slack_router
from apis.slack_api import router as slack_api_router
...
app.include_router(slack_router)  # Slack OAuth routes (/slack-auth/*)
app.include_router(slack_api_router)  # Slack API routes (/slack-api/*)
